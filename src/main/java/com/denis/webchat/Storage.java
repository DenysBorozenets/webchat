...
public class Storage {
    ...
    public Registration attachListener(ComponentEventListener<ChatEvent> messageListenner) {
        return eventBus.addListener(ChatEvent.class, messageListenner);
    }
